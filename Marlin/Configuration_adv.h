 ...
 */
#define E0_AUTO_FAN_PIN P2_04  // changed from default -1 per Teaching Tech to trigger HE fan @ 50c
 ...
 */
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       580                 //xyz_CURRENT per chris's basement utube
